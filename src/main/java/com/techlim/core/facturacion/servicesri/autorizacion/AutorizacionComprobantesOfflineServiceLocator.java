...
public class AutorizacionComprobantesOfflineServiceLocator extends org.apache.axis.client.Service implements com.techlim.core.facturacion.servicesri.autorizacion.AutorizacionComprobantesOfflineService {
    ...
    private java.lang.String AutorizacionComprobantesOfflinePort_address = "http://uio11rxvc120809:8080/comprobantes-electronicos-ws/AutorizacionComprobantesOffline";
    ...
    public com.techlim.core.facturacion.servicesri.autorizacion.AutorizacionComprobantesOffline getAutorizacionComprobantesOfflinePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.techlim.core.facturacion.servicesri.autorizacion.AutorizacionComprobantesOffline getAutorizacionComprobantesOfflinePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.techlim.core.facturacion.servicesri.autorizacion.AutorizacionComprobantesOfflineServiceSoapBindingStub _stub = new com.techlim.core.facturacion.servicesri.autorizacion.AutorizacionComprobantesOfflineServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.techlim.core.facturacion.servicesri.autorizacion.AutorizacionComprobantesOffline.class.isAssignableFrom(serviceEndpointInterface)) {
                com.techlim.core.facturacion.servicesri.autorizacion.AutorizacionComprobantesOfflineServiceSoapBindingStub _stub = new com.techlim.core.facturacion.servicesri.autorizacion.AutorizacionComprobantesOfflineServiceSoapBindingStub(new java.net.URL(AutorizacionComprobantesOfflinePort_address), this);
                _stub.setPortName(getAutorizacionComprobantesOfflinePortWSDDServiceName());
                return _stub;
            }
        }
