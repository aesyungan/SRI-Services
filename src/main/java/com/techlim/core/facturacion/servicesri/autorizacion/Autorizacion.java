...
public class Autorizacion  implements java.io.Serializable {
    ...
    private com.techlim.core.facturacion.servicesri.autorizacion.Mensaje[] mensajes;
    ...
    public Autorizacion(
           ...
           com.techlim.core.facturacion.servicesri.autorizacion.Mensaje[] mensajes) {
           this.estado = estado;
     ...
     * @return mensajes
     */
    public com.techlim.core.facturacion.servicesri.autorizacion.Mensaje[] getMensajes() {
        return mensajes;
    }
     ...
     * @param mensajes
     */
    public void setMensajes(com.techlim.core.facturacion.servicesri.autorizacion.Mensaje[] mensajes) {
        this.mensajes = mensajes;
    }
    ...
    static {
        ...
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("", "mensaje"));
        typeDesc.addFieldDesc(elemField);
    }
