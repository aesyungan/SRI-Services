...
public class Comprobante  implements java.io.Serializable {
    ...
    private com.techlim.core.facturacion.servicesri.recepcion.Mensaje[] mensajes;
    ...
    public Comprobante(
           ...
           com.techlim.core.facturacion.servicesri.recepcion.Mensaje[] mensajes) {
     ...
     * @return mensajes
     */
    public com.techlim.core.facturacion.servicesri.recepcion.Mensaje[] getMensajes() {
        return mensajes;
    }
     ...
     * @param mensajes
     */
    public void setMensajes(com.techlim.core.facturacion.servicesri.recepcion.Mensaje[] mensajes) {
        this.mensajes = mensajes;
    }
